# springboot-jwt for Webflux
## An Example Spring Boot Application for Securing a REST API with JSON Web Token (JWT)

- It requires java14+ because using `Record`.
- Uses webflux, Netty based.
 ...
 * Spring Boot 2.5.3 go to http://docs.spring.io/spring-boot/docs/2.5.3/reference/htmlsingle/ to learn more about spring boot
