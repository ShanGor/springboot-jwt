...
- Use Undertow instead of tomcat to improve the performance.
 ...
 * Spring Boot 2.1.4.RELEASE go to http://docs.spring.io/spring-boot/docs/2.1.4.RELEASE/reference/htmlsingle/ to learn more about spring boot
