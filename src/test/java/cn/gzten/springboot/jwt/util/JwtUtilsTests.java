...
public class JwtUtilsTests {
    private static final Logger log = Logger.getLogger(JwtUtilsTests.class.getName());
    ...
    public void testEncryptAndDecrypt() throws JsonProcessingException {
        var jwtUtils = new JwtUtils(privateKeystoreBase64, keystorePass, keyAlias, publicKeyBase64);
